...
const SECTIONS = [
  ...
  { title: '2. Descrição do Serviço', body: 'A nicotinacat oferece uma plataforma de comunidade com recursos sociais, sistema de progressão, coleção de cards, expedições e agregação de conteúdo de plataformas conectadas. Reservamo-nos o direito de modificar ou descontinuar qualquer funcionalidade a qualquer momento.' },
  ...
  { title: '6. Itens Virtuais e Progressão', body: 'O sistema de progressão inclui itens virtuais, cards, ouro e mecânicas de evolução. Estes itens virtuais não têm valor monetário e não podem ser trocados por moeda real. Podemos ajustar a economia, o balanceamento ou as funcionalidades a nosso critério.' },
