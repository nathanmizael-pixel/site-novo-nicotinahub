...
const SECTIONS = [
  ...
  { title: '2. Como Usamos Suas Informações', body: 'Usamos suas informações para: criar e gerenciar sua conta; exibir seu perfil e conteúdo para a comunidade; fornecer recursos do arcade e progressão; enviar notificações sobre atividade; e melhorar a nicotinacat.' },
  { title: '3. Armazenamento de Dados', body: 'Seus dados são armazenados com segurança usando a infraestrutura da Supabase. Dados de autenticação, informações de perfil, posts e estado do arcade são armazenados em um banco de dados PostgreSQL com políticas de segurança em nível de linha.' },
  { title: '4. Dados de Autenticação', body: 'Usamos Supabase Auth para gerenciamento de contas. Sua senha é hasheada e nunca armazenada em texto plano. Não usamos provedores de login social a menos que solicitado explicitamente.' },
  ...
  { title: '6. Serviços de Terceiros', body: 'A nicotinacat linka e pode integrar com serviços de terceiros incluindo Twitch, TikTok, Discord e Amazon. Esses serviços têm suas próprias políticas de privacidade que regem como lidam com seus dados.' },
