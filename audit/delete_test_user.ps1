...
$response = Invoke-RestMethod -Uri "https://jivrkozxthsfleewakvc.supabase.co/auth/v1/admin/users/4bfabbaa-17c0-4613-97cb-588af44b1819" -Method DELETE -Headers $headers
