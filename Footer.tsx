...
import { SOCIAL_LINKS } from '@/data/arcade';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-text-muted max-w-md leading-relaxed">
              The central hub of the nicotinacat community. Stream, play, collect, and connect
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/live" className="text-sm text-text hover:text-primary-bright transition-colors">Live</Link></li>
              <li><Link to="/clips" className="text-sm text-text hover:text-primary-bright transition-colors">Clips</Link></li>
              <li><Link to="/arcade" className="text-sm text-text hover:text-primary-bright transition-colors">Arcade</Link></li>
